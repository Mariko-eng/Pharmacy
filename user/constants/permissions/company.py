...
company_group_level_permissions = [
    ...
    ("delete_company_group","Delete company group"),
]
...
store_group_level_permissions = [
    ...
    ("delete_store_group","Delete store group"),
]
...
pos_center_permissions = [
    ...
    ("delete_pos_center","Delete pos center"),
]
...
supplier_entity_permissions = [
    ...
    ("delete_supplier_entity","Delete supplier entity"),
]
