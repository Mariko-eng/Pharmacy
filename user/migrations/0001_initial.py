    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('App Admin', 'App Admin'), ('Company Admin', 'Company Admin'), ('Store Manager', 'Store Manager'), ('Cashier', 'Cashier')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user_role', models.CharField(choices=[('App Admin', 'App Admin'), ('Company Admin', 'Company Admin'), ('Store Manager', 'Store Manager'), ('Cashier', 'Cashier')], max_length=255)),
                ('updated_by', models.CharField(blank=True, max_length=225, null=True)),
