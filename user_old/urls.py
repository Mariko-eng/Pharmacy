...
urlpatterns = [
    ...
    path('users-and-roles/', views.users_and_roles_list, name='users-and-roles-list'),
    ...
    path('company/<int:company_id>/users/add/', views.company_users_new, name='company-users-new'),
    path('company/<int:company_id>/roles/', views.company_roles_list, name='company-roles-list'),
    path('company/<int:company_id>/roles/add', views.company_roles_new, name='company-roles-new'),
